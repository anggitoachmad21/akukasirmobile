...
public class DailyReportDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date.setOnClickListener((View.OnClickListener) v -> new DatePickerDialog(DailyReportDetail.this, (DatePickerDialog.OnDateSetListener) (view, year, month, dayOfMonth) -> {
