...
public class ProductionListActivity extends AppCompatActivity implements ProductionAdapter.ProductionAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddProduction.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), InventoryProductionActivity.class);
