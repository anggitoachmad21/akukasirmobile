...
import id.latenight.creativepos.tabs.AdminActivityTabs;
import id.latenight.creativepos.tabs.ExpenseActivityTabs;
import id.latenight.creativepos.tabs.LoginActivityTabs;
import id.latenight.creativepos.tabs.MainActivityTabs;
import id.latenight.creativepos.tabs.OrderRunningActivityTabs;
...
//        setContentView(R.layout.activity_menu);
        setContentView(R.layout.activity_menu_thema_2);
        ...
        RadioButton convert = findViewById(R.id.konversi);
    ...
    private void requestPermissions() {
        ActivityCompat.requestPermissions(MenuActivity.this, new String[]{READ_EXTERNAL_STORAGE}, REQUEST_PERMISSION_CODE);
    }
...
//                startActivity(intent);
//            }
            intent = new Intent(this, MenuActivityN.class);
            startActivity(intent);
        }
        ...
        if (v.getId() == R.id.order_history) {
            if(is_tabs == false) {
                intent = new Intent(this, OrderRunningActivity.class);
                startActivity(intent);
            }else{
        ...
        if (v.getId() == R.id.purchase) {
            intent = new Intent(this, PurchaseOrderListActivity.class);
            startActivity(intent);
        }
        if (v.getId() == R.id.inventory_receive) {
            intent = new Intent(this, InventoryReceiveListActivity.class);
            startActivity(intent);
        }
        ...
        if (v.getId() == R.id.inventory_transfer) {
            intent = new Intent(this, InventoryTransferListActivity.class);
            startActivity(intent);
        }
