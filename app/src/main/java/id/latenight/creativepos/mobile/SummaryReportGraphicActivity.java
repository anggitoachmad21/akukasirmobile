...
public class SummaryReportGraphicActivity extends AppCompatActivity {
    ...
    public void shareInvoice(View view) {
        ProgressDialog dialog = ProgressDialog.show(SummaryReportGraphicActivity.this, "",
        ...
        if (bm != null) {
            try {
                ...
                fOut.close();
                bm.recycle();
                Uri bmpUri = FileProvider.getUriForFile(SummaryReportGraphicActivity.this, BuildConfig.APPLICATION_ID , file);
