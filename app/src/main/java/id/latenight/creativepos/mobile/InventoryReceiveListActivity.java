...
public class InventoryReceiveListActivity extends AppCompatActivity implements InventoryReceiveAdapter.InventoryReceiveAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddInventoryReceive.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), InventoryReceiveActivity.class);
