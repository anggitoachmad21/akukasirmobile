...
public class PurchaseOrderListActivityTabs extends AppCompatActivity implements PurchaseAdapter.PurchaseAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddPurchase.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), PurchaseOrderActivityTabs.class);
    ...
    public void onOrderSelected(Purchase item) {
        Intent intent = new Intent(this, PurchaseOrderDetailActivityTabs.class);
