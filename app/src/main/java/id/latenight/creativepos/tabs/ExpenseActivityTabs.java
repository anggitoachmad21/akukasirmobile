...
public class ExpenseActivityTabs extends AppCompatActivity implements ExpenseAdapter.ExpenseAdapterListener {
...
//        startActivity(intent);
    ...
    public void expenseForm(View view) {
        Intent intent = new Intent(this, ExpenseFormActivityTabs.class);
        startActivity(intent);
    }
