...
public class SummaryReportAllOutletActivityTabs extends AppCompatActivity {
    ...
    public void shareInvoice(View view) {
        ProgressDialog dialog = ProgressDialog.show(SummaryReportAllOutletActivityTabs.this, "",
        ...
        if (bm != null) {
            try {
                ...
                fOut.close();
                bm.recycle();
                Uri bmpUri = FileProvider.getUriForFile(SummaryReportAllOutletActivityTabs.this, BuildConfig.APPLICATION_ID , file);
