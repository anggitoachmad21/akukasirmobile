...
import id.latenight.creativepos.mobile.InventoryTransferActivity;
import id.latenight.creativepos.mobile.InventoryTransferDetailActivity;
...
public class InventoryTransferListActivityTabs extends AppCompatActivity implements InventoryTransferAdapter.InventoryTransferAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddInventoryTransfer.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), InventoryTransferActivityTabs.class);
    ...
    public void onOrderSelected(InventoryTransfer item) {
        Intent intent = new Intent(this, InventoryTransferDetailActivityTabs.class);
