...
public class SummaryReportGraphicActivityTabs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summary_report_graphic);
        ...
        url = URI.API_SUMMARY_REPORT_GRAPHIC(session.getPathUrl())+session.getId() + "?outlet="+param_outlet_id+"&start_date=" + param_start_date + "&end_date=" + param_end_date;
        webView.loadUrl(url);
    ...
    public void shareInvoice(View view) {
        ProgressDialog dialog = ProgressDialog.show(SummaryReportGraphicActivityTabs.this, "",
        ...
        if (bm != null) {
            try {
                ...
                fOut.close();
                bm.recycle();
                Uri bmpUri = FileProvider.getUriForFile(SummaryReportGraphicActivityTabs.this, BuildConfig.APPLICATION_ID , file);
