...
public class SummaryReportActivityTabs extends AppCompatActivity {
    ...
    public void shareInvoice(View view) {
        ProgressDialog dialog = ProgressDialog.show(SummaryReportActivityTabs.this, "",
        ...
        if (bm != null) {
            try {
                ...
                fOut.close();
                bm.recycle();
                Uri bmpUri = FileProvider.getUriForFile(SummaryReportActivityTabs.this, BuildConfig.APPLICATION_ID , file);
