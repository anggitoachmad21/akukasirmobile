...
public class IncomeStatementActivityTabs extends AppCompatActivity {
    ...
    public void shareInvoice(View view) {
        ProgressDialog dialog = ProgressDialog.show(IncomeStatementActivityTabs.this, "",
        ...
        if (bm != null) {
            try {
                ...
                fOut.close();
                bm.recycle();
                Uri bmpUri = FileProvider.getUriForFile(IncomeStatementActivityTabs.this, BuildConfig.APPLICATION_ID , file);
