...
public class CustomerSpinnerAdapter extends RecyclerView.Adapter<CustomerSpinnerAdapter.ViewHolder> implements Filterable {
    ...
    public CustomerSpinnerAdapter(List<Customer> order, Context ct, CustomerAdapterListener listener) {
        this.order = order;
    ...
    public interface CustomerAdapterListener {
        @SuppressLint("SetTextI18n")
        void onRemoveItem(List<Cart> item);
    ...
    public class CustomFilter extends Filter{
        ...
        CustomerSpinnerAdapter adapter;
        List<Customer> filterList;

        public CustomFilter(List<Customer> filterList, CustomerSpinnerAdapter adapter)
        {
